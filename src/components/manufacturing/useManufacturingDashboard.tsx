...
const processStages = [
  ...
  { id: "04", processCode: "ASSEMBLY", name: "조립", rate: 91, events: 22, status: "normal", color: "#22c55e" },
  { id: "05", name: "AI 분석", rate: null, defectRate: 78, targetProcess: "도장(L3)", status: "analysis" },
]
