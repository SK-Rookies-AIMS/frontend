            ...
            {agvs.map((agv) => {
              ...
              const filterId = agv.status === "MOVING" ? "glow-cyan"
                : agv.status === "RETURNING" ? "glow-purple"
                  : agv.status === "UNLOADING" ? "glow-green"
                    : "glow-yellow"
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <div className="h-1.5 w-full bg-slate-950 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: `${(movingCount / safeTotal) * 100}%` }}
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="h-1.5 w-full bg-slate-950 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-green-400 shadow-[0_0_8px_rgba(74,222,128,0.8)] transition-all duration-500"
                    style={{
                      width: `${(unloadingCount / safeTotal) * 100}%`
                    }}
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="h-1.5 w-full bg-slate-950 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: `${(returningCount / safeTotal) * 100}%` }}
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="h-1.5 w-full bg-slate-950 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: `${(waitingCount / safeTotal) * 100}%` }}
                  />
                </div>
              </div>
            </div>
